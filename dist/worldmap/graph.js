...
import { isBearingSegment, isImmortalRealmName, isJunkLocationName, isTrivialFacility, looksLikeDescription, nodeId, normalize, joinSegments, splitSegments, } from './path.js';
...
export function bearingOf(name) {
